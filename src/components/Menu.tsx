...
const Menu: React.FC = () => {
  ...
  const burgers = [
    { slug: 'westers-classic', name: { en: 'Westers Classic', sv: 'Westers Classic' }, desc: { en: 'Cheddar, Westers dressing, caramelized onion', sv: 'Cheddar, Westers dressing, karamelliserad lök' }, img: '/pexels-chevanon-1108117.jpg' },
    { slug: 'fire-jam', name: { en: 'Fire Jam', sv: 'Fire Jam' }, desc: { en: 'Cheddar, fresh jalapeño, pickled jalapeño, caramelized onion, black pepper mayo', sv: 'Cheddar, färsk jalapeño, picklad jalapeño, karamelliserad lök, svartpepparmajonnäs' }, img: '/pexels-chevanon-1108117.jpg' },
    { slug: 'smoke-stack', name: { en: 'Smoke Stack', sv: 'Smoke Stack' }, desc: { en: 'Bacon jam, cheddar, chipotle mayo, crispy onions', sv: 'Baconmarmelad, cheddar, chipotlemajo, krispig lök' }, img: '/pexels-chevanon-1108117.jpg' },
    { slug: 'triple-threat', name: { en: 'Triple Threat', sv: 'Triple Threat' }, desc: { en: 'Cheddar, house cheese sauce, pepper jack, pickled red onion', sv: 'Cheddar, husets ostsås, pepper jack, picklad rödlök' }, img: '/pexels-chevanon-1108117.jpg' },
    { slug: 'blue-moon', name: { en: 'Blue Moon', sv: 'Blue Moon' }, desc: { en: 'Blue cheese, caramelized onion, buffalo sauce', sv: 'Blåmögelost, karamelliserad lök, buffalo-sås' }, img: '/pexels-chevanon-1108117.jpg' },
    { slug: 'guldgruvan', name: { en: 'Guldgruvan', sv: 'Guldgruvan' }, desc: { en: 'Truffle mayo, caramelized onion, cheddar', sv: 'Tryffelmajo, karamelliserad lök, cheddar' }, img: '/pexels-chevanon-1108117.jpg' },
