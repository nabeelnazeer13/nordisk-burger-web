...
const Menu: React.FC = () => {
  ...
  const burgers = [
    ...
    { slug: 'fire-jam', name: { en: 'Fire Jam', sv: 'Fire Jam' }, desc: { en: 'Cheddar, fresh jalapeño, pickled jalapeño, caramelized onion, black pepper mayo', sv: 'Cheddar, färsk jalapeño, picklad jalapeño, karamelliserad lök, svartpepparmajonnäs' }, img: '/lovable-uploads/bfea0020-22de-4c9a-9c28-03cfb9be3b85.png' },
    ...
    { slug: 'triple-threat', name: { en: 'Triple Threat', sv: 'Triple Threat' }, desc: { en: 'Cheddar, house cheese sauce, pepper jack, pickled red onion', sv: 'Cheddar, husets ostsås, pepper jack, picklad rödlök' }, img: '/lovable-uploads/117b8b4d-221c-4966-ab3b-c0f76b36bc22.png' },
              ...
              <figure key={item.slug} className="group relative overflow-hidden rounded-2xl">
                <div className="aspect-[4/3] overflow-hidden">
                  <img
                    ...
                    loading="lazy"
                    className={`w-full h-full object-cover transition-transform duration-500 ease-out group-hover:scale-105 ${(item.slug === 'fire-jam' || item.slug === 'triple-threat') ? 'scale-75' : ''}`}
                  />
                </div>
