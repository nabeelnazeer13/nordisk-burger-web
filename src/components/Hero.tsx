        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10 lg:gap-14">
          ...
          <div className="relative z-10">
            <img
              ...
              alt="Signature burger on wooden board"
              loading="eager"
          ...
          <div ref={heroRef} className="max-w-sm sm:max-w-lg md:max-w-xl text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start gap-4 max-w-xs sm:max-w-none mx-auto md:mx-0">
              ...
              <a
                ...
                className="btn bg-white/80 backdrop-blur-sm border border-nordic-charcoal/10 text-nordic-charcoal hover:bg-nordic-charcoal hover:text-nordic-offwhite rounded-full transition-all duration-300 shadow-lg px-6 py-3"
              >
                {t.hero.findUs}
              </a>
              <a
