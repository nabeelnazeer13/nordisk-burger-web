        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="fade-in-section">
            <div className="relative">
              ...
              <img src="/ChatGPT Image Jul 24, 2025 at 08_00_24 PM.png" alt="Nordic landscape representing our philosophy" className="w-full h-auto object-cover rounded-lg shadow-md relative z-10" />
            </div>
          </div>
